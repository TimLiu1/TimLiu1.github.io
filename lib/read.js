...
exports.userOrder = function(offset,limit,callback){
    debug('获取指定要求的订单');
    var userOrderGetSql = 'SELECT o.`ORDERID`,o.`CREATETIME`,u.`USERNAME`,t.`TOURISMTITLE` FROM `userorder` o LEFT JOIN `USER` u ON o.`USERID` =  u.`USERID` LEFT JOIN `tourism` t ON o.`TOURISM` = t.`TOURISMID`'+ 
